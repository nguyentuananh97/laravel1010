    	...
    	<nav class="menu-desktop menu-sticky">
            ...
            <ul class="tada-menu">
                     <li><a href="#" class="active">HOME <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                        	<li><a href="{{asset('home')}}">Home 1 Column</a></li>
                            <li><a href="{{asset('home')}}" class="active">Home 1 Column + Sidebar</a></li>                            
                            <li><a href="{{asset('home')}}">Home 2 Columns + Sidebar</a></li>
                            <li><a href="{{asset('home')}}">Home 2 Columns</a></li>
                            <li><a href="{{asset('home')}}">Home 3 Columns</a></li>                                                                      
                        </ul>
                    </li>
                    <li><a href="#">FEATURES <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                            <li><a href="{{asset('page')}}">Page</a></li>
                            <li><a href="{{asset('page')}}">Page + Right Sidebar</a></li>
                            <li><a href="{{asset('page')}}">Page + Left Sidebar</a></li>                            
                            <li><a href="{{asset('post')}}">Post Full Width</a></li>
                            <li><a href="{{asset('post')}}">Post + Right Sidebar</a></li>
                            <li><a href="{{asset('post')}}">Post + Left Sidebar</a></li>
                            <li><a href="{{asset('post')}}">No Sticky Menu</a></li>
                            <li><a href="{{asset('post')}}">No Slider</a></li> 
                    ...
                    <li><a href="#">BLOG <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                        	<li><a href="{{asset('blog')}}">Blog 1 Column</a></li>
                            <li><a href="{{asset('blog')}}">Blog + Sidebar</a></li>                            
                            <li><a href="{{asset('blog')}}">Blog 2 Columns + Sidebar</a></li>
                            <li><a href="{{asset('blog')}}">Blog 2 Columns</a></li>
                            <li><a href="{{asset('blog')}}">Blog 3 Columns</a></li>                                                                      
                        </ul>                
                    </li> 
